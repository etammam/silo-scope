...
/// <summary>
/// Loads and discovers Orleans grain interfaces from DLL or NuGet package sources.
/// </summary>
...
)
{
    ...
    {
        return entry.SourceType == InterfaceSourceType.Dll
                ? Path.GetFileName(entry.DllPath ?? string.Empty)
            : entry.PackageVersion is null ? entry.PackageId ?? "NuGet package"
...
#pragma warning disable IL3000
            return string.Equals(assembly.Location, fullPath, StringComparison.OrdinalIgnoreCase);
