...
import { FAKER_FIELDS, FAKER_LOCALES, hasMockTokens } from "../mock-tokens";
...
const REGISTERED_COMPLETION_LANGUAGES = new Set<string>();
...
export function MonacoEditor({
  ...
  const handleBeforeMount: BeforeMount = (monaco) => {
    ...
    if (!REGISTERED_COMPLETION_LANGUAGES.has("json")) {
      REGISTERED_COMPLETION_LANGUAGES.add("json");
      monaco.languages.registerCompletionItemProvider("json", {
        triggerCharacters: ["{", ":", "."],
        provideCompletionItems: provideCompletions,
      });
    }
    if (!REGISTERED_COMPLETION_LANGUAGES.has("text")) {
      REGISTERED_COMPLETION_LANGUAGES.add("text");
