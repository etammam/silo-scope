import { Briefcase, Folder, Globe, Network, Package, Settings } from "lucide-react";

export type ActivityView = "workspace" | "topology" | "nuget" | "settings" | "workspaces" | "environments";
